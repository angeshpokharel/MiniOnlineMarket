...
var YearPicker = function (_a) {
    ...
    var years = React.useMemo(function () {
        return range(2000, 2085).map(function (year) { return ({
            label: year.toString(),
            value: year,
        }); });
    }, []);
...
var NepaliDatePicker = function (_a) {
    var className = _a.className, defaultDate = _a.defaultDate, onDateSelect = _a.onDateSelect;
    var _b = React.useState(false), showCalendar = _b[0], setShowCalendar = _b[1];
    var dateEl = React.useRef(null);
    var today = ADToBS(new Date());
    var _c = React.useState(defaultDate || today), value = _c[0], setValue = _c[1];
    ...
    return (React__default.createElement(ConfigProvider, null,
        React__default.createElement("input", { type: "text", className: className, readOnly: true, ref: dateEl, value: value, onClick: function () { return setShowCalendar(!showCalendar); } }),
        showCalendar && React__default.createElement(Calender, { value: value, onChange: handleOnChange })));
};
