...
var NepaliDatePicker = function (_a) {
    ...
    var _c = useState(defaultDate || today), value = _c[0], setValue = _c[1];
    ...
    return (React.createElement(ConfigProvider, null,
        React.createElement("input", { type: "text", className: className, readOnly: true, ref: dateEl, value: value, onClick: function () { return setShowCalendar(!showCalendar); } }),
        showCalendar && React.createElement(Calender, { value: value, onChange: handleOnChange })));
};
