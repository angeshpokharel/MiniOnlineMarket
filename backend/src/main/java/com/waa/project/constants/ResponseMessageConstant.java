package com.waa.project.constants;
...
public class ResponseMessageConstant {
  ...
  public final static String RESET_PASSWORD_EMAIL_SEND = "Reset password email sent";
  public final static String PASSWORD_DID_NOT_MATCH = "Password did not match";
  public final static String OLD_PASSWORD_DID_NOT_MATCH = "Old Password did not match";
  public final static String RESET_TOKEN_EXPIRED= "Reset Token has expired.";
